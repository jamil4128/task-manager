...
router.patch("/tasks/:id", function _callee4(req, res) {
  var allowedUpdate, triedUpdate, isUpdatable, task;
  return regeneratorRuntime.async(function _callee4$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          allowedUpdate = ["description", "completed"];
          triedUpdate = Object.keys(req.body);
          isUpdatable = triedUpdate.every(function (update) {
        ...
        case 11:
          triedUpdate.forEach(function (update) {
        ...
        case 17:
          ...
          res.retrun(400).send(_context4.t0);
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 9:
          ...
          res["return"](400).send(_context5.t0);
